	...
	public EmpList() {
		...
		table.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				tfEmpno.setText(String.valueOf(table.getValueAt(idx, 0)));
				tfName.setText(String.valueOf(table.getValueAt(idx, 1)));
				tfHiredate.setText(String.valueOf(table.getValueAt(idx, 2)));
				tfSal.setText(String.valueOf(table.getValueAt(idx, 3)));
			}
		});
